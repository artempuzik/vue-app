...
const messages = {
  en: {
    ...
    buttons: {
      ...
      no_really: 'Not really',
      reprice: 'Reprice',
      auto_reprice: 'Auto-repricing',
    },
    settings: {
      settings: 'Settings',
      language: 'Language',
    ...
    dashboard: {
      ...
      price: 'Price changes',
      metric: 'Key metric overview',
      recommended: 'Recommended products',
      recommended_sub: 'sorted by the largest profit potential',
      profit: 'Profit',
      revenue: 'Revenue',
      avtomative: 'Avomative',
      error: 'Error',
      ...
      more: 'View more',
      all: 'View all',
      question: 'do you like using Relu?'
    },
    product: {
      info: 'General Info',
      metric: 'Key Metrics Overview',
      profit: 'Profit',
      revenue: 'Revenue',
      sales: 'Sales',
      margin: 'Margin',
      ...
      set_up: 'Set up',
      set_up_sub: 'All metrics are used as a monthly ones.',
      goal: 'Your Goal',
      min_sales: 'Min. Sales',
      max_sales: 'Max. Sales',
      min_price: 'Min. Price',
